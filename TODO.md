...
* try to adhere more to data flow principles, keeping as few classes as possible with minimal access to inner data, moving methods that do non trivial processing outside
