                           ...
                           double        t[3])
{
    ...
    //if((B0 - test0).length() > 1e-10) cout << (B0 - test0).length() << "\t" << tet_scaled_jacobian(A0,A1,A2,A3) << "\t" << tet_scaled_jacobian(B0,B1,B2,B3) << endl;
    //if((B1 - test1).length() > 1e-10) cout << (B1 - test1).length() << "\t" << tet_scaled_jacobian(A0,A1,A2,A3) << "\t" << tet_scaled_jacobian(B0,B1,B2,B3) << endl;
    //if((B2 - test2).length() > 1e-10) cout << (B2 - test2).length() << "\t" << tet_scaled_jacobian(A0,A1,A2,A3) << "\t" << tet_scaled_jacobian(B0,B1,B2,B3) << endl;
    //if((B3 - test3).length() > 1e-10) cout << (B3 - test3).length() << "\t" << tet_scaled_jacobian(A0,A1,A2,A3) << "\t" << tet_scaled_jacobian(B0,B1,B2,B3) << endl;
