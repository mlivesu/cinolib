...
*     Italy                                                                      *
**********************************************************************************/
#include <cinolib/gui/qt/surface_mesh_control_panel2.h>
...
template<class Mesh>
SurfaceMeshControlPanel2<Mesh>::SurfaceMeshControlPanel2(Mesh *m, GLcanvas2 *canvas, QWidget *parent)
    : m(m)
    , canvas(canvas)
{
    assert(canvas != NULL);
...
template<class Mesh>
CINO_INLINE
void SurfaceMeshControlPanel2<Mesh>::show()
{
    widget->show();
}
...
template<class Mesh>
CINO_INLINE
void SurfaceMeshControlPanel2<Mesh>::set_title()
{
    if (m != NULL)
    {
...
template<class Mesh>
CINO_INLINE
void SurfaceMeshControlPanel2<Mesh>::set_tex1d()
{
...
template<class Mesh>
CINO_INLINE
void SurfaceMeshControlPanel2<Mesh>::set_tex2d()
{
    if (m == NULL || canvas == NULL) return;
...
template<class Mesh>
CINO_INLINE
void SurfaceMeshControlPanel2<Mesh>::set_slice()
{
    if (m == NULL || canvas == NULL) return;
    SlicerState s;
...
template<class Mesh>
CINO_INLINE
void SurfaceMeshControlPanel2<Mesh>::set_isocurve()
{
    if (m == NULL || canvas == NULL) return;
...
template<class Mesh>
void SurfaceMeshControlPanel2<Mesh>::connect()
{
