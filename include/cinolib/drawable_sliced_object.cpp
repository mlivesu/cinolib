...
//CINO_INLINE
//DrawableSlicedObj<M,V,E,P>::DrawableSlicedObj(const char * filename) : DrawableTrimesh<>()
//{
...
//template<class M, class V, class E, class P>
//CINO_INLINE
//DrawableSlicedObj<M,V,E,P>::DrawableSlicedObj(const std::vector<std::vector<std::vector<vec3d>>> & internal_polylines,
...
//template<class M, class V, class E, class P>
//CINO_INLINE
//void DrawableSlicedObj<M,V,E,P>::triangulate_slices(const std::vector<std::vector<std::vector<vec3d>>> & internal_polylines,
//                                                    const std::vector<std::vector<std::vector<vec3d>>> & external_polylines,
//                                                    const std::vector<std::vector<std::vector<vec3d>>> & open_polylines)
//{
...
//    this->updateGL();
//    //this->show_texture1D(TEXTURE_1D_HSV_RAMP);
//}
...
//template<class M, class V, class E, class P>
//CINO_INLINE
//void DrawableSlicedObj<M,V,E,P>::points_inside_holes(const std::vector<std::vector<vec3d>> & holes,
