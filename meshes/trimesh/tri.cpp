...
template<class M, class V, class E, class F>
CINO_INLINE
double Tri<M,V,E,F>::face_area(const uint fid) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
double Tri<M,V,E,F>::face_mass(const uint fid) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
vec3d Tri<M,V,E,F>::centroid() const
{
    vec3d bary(0,0,0);
...
template<class M, class V, class E, class F>
CINO_INLINE
std::vector<uint> Tri<M,V,E,F>::get_boundary_vertices() const
{
    std::vector<uint> res;
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::face_bary_coords(const uint fid, const vec3d & P, std::vector<double> & wgts) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::face_bary_is_vert(const uint fid, const std::vector<double> & wgts, uint & vid, const double tol) const
{
    uint off;
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::elem_bary_is_vert(const uint fid, const std::vector<double> & wgts, uint & vid, const double tol) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::face_bary_is_edge(const uint fid, const std::vector<double> & wgts, uint & eid, const double tol) const
{
    uint off;
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::elem_bary_is_edge(const uint fid, const std::vector<double> & wgts, uint & eid, const double tol) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
uint Tri<M,V,E,F>::face_edge_id(const uint fid, const uint offset) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::face_is_boundary(const uint fid) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
uint Tri<M,V,E,F>::face_vert_offset(const uint fid, const uint vid) const
{
    for(uint offset=0; offset<verts_per_face(); ++offset)
    {
...
template<class M, class V, class E, class F>
CINO_INLINE
uint Tri<M,V,E,F>::face_shared(const uint eid0, const uint eid1) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
int Tri<M,V,E,F>::face_adjacent_along(const uint fid, const uint vid0, const uint vid1) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
double Tri<M,V,E,F>::face_angle_at_vert(const uint fid, const uint vid, const int unit) const
{
    uint offset;
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::face_is_cap(const uint fid, const double angle_thresh_deg) const
{
    for(uint offset=0; offset<verts_per_face(); ++offset)
    {
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::face_is_needle(const uint fid, const double angle_thresh_deg) const
{
    for(uint offset=0; offset<verts_per_face(); ++offset)
    {
        uint vid = face_vert_id(fid,offset);
...
template<class M, class V, class E, class F>
CINO_INLINE
uint Tri<M,V,E,F>::face_add(const uint vid0, const uint vid1, const uint vid2, const F & data)
{
...
template<class M, class V, class E, class F>
CINO_INLINE
void Tri<M,V,E,F>::face_switch_id(const uint fid0, const uint fid1)
{
...
template<class M, class V, class E, class F>
CINO_INLINE
void Tri<M,V,E,F>::face_remove_unreferenced(const uint fid)
{
...
template<class M, class V, class E, class F>
CINO_INLINE
std::set<uint> Tri<M,V,E,F>::vert_n_ring(const uint vid, const uint n) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
double Tri<M,V,E,F>::vert_area(const uint vid) const
{
    double area = 0.0;
...
template<class M, class V, class E, class F>
CINO_INLINE
double Tri<M,V,E,F>::vert_mass(const uint vid) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
uint Tri<M,V,E,F>::vert_opposite_to(const uint fid, const uint vid0, const uint vid1) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
uint Tri<M,V,E,F>::vert_opposite_to(const uint eid, const uint vid) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::vert_is_boundary(const uint vid) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::verts_are_adjacent(const uint vid0, const uint vid1) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
uint Tri<M,V,E,F>::vert_valence(const uint vid) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
uint Tri<M,V,E,F>::vert_shared(const uint eid0, const uint eid1) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::vert_is_local_min(const uint vid, const int tex_coord) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::vert_is_local_max(const uint vid, const int tex_coord) const
{
    for(uint nbr : adj_v2v(vid))
    {
        switch (tex_coord)
...
template<class M, class V, class E, class F>
CINO_INLINE
bool Tri<M,V,E,F>::vert_is_critical_p(const uint vid) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
std::vector<uint> Tri<M,V,E,F>::vert_boundary_edges(const uint vid) const
{
...
template<class M, class V, class E, class F>
CINO_INLINE
uint Tri<M,V,E,F>::vert_add(const vec3d & pos, const V & data)
{
    uint vid = num_verts();
    verts.push_back(pos);
...
template<class M, class V, class E, class F>
CINO_INLINE
void Tri<M,V,E,F>::vert_switch_id(const uint vid0, const uint vid1)
{
...
template<class M, class V, class E, class F>
CINO_INLINE
void Tri<M,V,E,F>::vert_remove_unreferenced(const uint vid)
{
...
template<class M, class V, class E, class F>
CINO_INLINE
void Tri<M,V,E,F>::vert_ordered_one_ring(const uint vid,
...
template<class M, class V, class E, class F>
CINO_INLINE
std::vector<uint> Tri<M,V,E,F>::vert_ordered_vert_ring(const uint vid) const
{
    std::vector<uint> v_ring; // sorted list of adjacent vertices
    std::vector<uint> f_ring; // sorted list of adjacent triangles
    std::vector<uint> e_ring; // sorted list of edges incident to vid
...
template<class M, class V, class E, class F>
CINO_INLINE
std::vector<uint> Tri<M,V,E,F>::vert_ordered_face_ring(const uint vid) const
{
    std::vector<uint> v_ring; // sorted list of adjacent vertices
    std::vector<uint> f_ring; // sorted list of adjacent triangles
    std::vector<uint> e_ring; // sorted list of edges incident to vid
...
template<class M, class V, class E, class F>
CINO_INLINE
std::vector<uint> Tri<M,V,E,F>::vert_ordered_edge_ring(const uint vid) const
{
    std::vector<uint> v_ring; // sorted list of adjacent vertices
    std::vector<uint> f_ring; // sorted list of adjacent triangles
    std::vector<uint> e_ring; // sorted list of edges incident to vid
...
template<class M, class V, class E, class F>
CINO_INLINE
std::vector<uint> Tri<M,V,E,F>::vert_ordered_edge_link(const uint vid) const
{
    std::vector<uint> v_ring; // sorted list of adjacent vertices
    std::vector<uint> f_ring; // sorted list of adjacent triangles
    std::vector<uint> e_ring; // sorted list of edges incident to vid
