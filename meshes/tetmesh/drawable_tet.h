...
* for more details.                                                         *
****************************************************************************/
#ifndef CINO_DRAWABLE_TET_H
#define CINO_DRAWABLE_TET_H
...
class DrawableTet : public Tet<M,V,E,F,C>, public DrawableObject
{
    ...
    public:
        ...
        DrawableTet(const char * filename);

        DrawableTet(const std::vector<vec3d> & verts,
                    const std::vector<uint>  & cells);

        DrawableTet(const std::vector<double> & coords,
                    const std::vector<uint>   & cells);
    ...
    protected:
        ...
        MeshSlicer<Tet<M,V,E,F,C>> slicer;
    ...
    public:
        ...
        void vert_set_color(const Color & c) { Tet<M,V,E,F,C>::vert_set_color(c); updateGL(); }
        void edge_set_color(const Color & c) { Tet<M,V,E,F,C>::edge_set_color(c); updateGL(); }
        void face_set_color(const Color & c) { Tet<M,V,E,F,C>::face_set_color(c); updateGL(); }
        void cell_set_color(const Color & c) { Tet<M,V,E,F,C>::cell_set_color(c); updateGL(); }
        void vert_set_alpha(const float   a) { Tet<M,V,E,F,C>::vert_set_alpha(a); updateGL(); }
        void edge_set_alpha(const float   a) { Tet<M,V,E,F,C>::edge_set_alpha(a); updateGL(); }
        void face_set_alpha(const float   a) { Tet<M,V,E,F,C>::face_set_alpha(a); updateGL(); }
        void cell_set_alpha(const float   a) { Tet<M,V,E,F,C>::cell_set_alpha(a); updateGL(); }
...
#include "drawable_tet.cpp"
#endif

#endif // #ifdef CINOLIB_USES_OPENGL

#endif // CINO_DRAWABLE_TET_H
