...
* for more details.                                                         *
****************************************************************************/
#include <cinolib/meshes/tetmesh/drawable_tet.h>
...
CINO_INLINE
DrawableTet<M,V,E,F,C>::DrawableTet() : Tet<M,V,E,F,C>()
{
    init_drawable_stuff();
}
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
DrawableTet<M,V,E,F,C>::DrawableTet(const char *filename)
    : Tet<M,V,E,F,C>(filename)
{
    init_drawable_stuff();
}
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
DrawableTet<M,V,E,F,C>::DrawableTet(const std::vector<vec3d> & verts,
                                    const std::vector<uint>  & cells)
    : Tet<M,V,E,F,C>(verts, cells)
{
    init_drawable_stuff();
}
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
DrawableTet<M,V,E,F,C>::DrawableTet(const std::vector<double> & coords,
                                    const std::vector<uint>   & cells)
    : Tet<M,V,E,F,C>(coords, cells)
{
    init_drawable_stuff();
}
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::init_drawable_stuff()
{
    type   = TETMESH;
    slicer = MeshSlicer<Tet<M,V,E,F,C>>(*this);
    ...
    Tet<M,V,E,F,C>::face_set_color(Color::YELLOW());
    Tet<M,V,E,F,C>::cell_set_color(Color::WHITE());
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::draw(const float) const
{
    render(drawlist_in );
    render(drawlist_out);
}
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::updateGL()
{
    updateGL_out();
    updateGL_in();
}
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::updateGL_out()
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::updateGL_in()
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::slice(const float thresh, // thresh on centroids or quality
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_mesh(const bool b)
{
    if (b)
    {
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_mesh_flat()
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_mesh_smooth()
{
    drawlist_in.draw_mode  |=  DRAW_TRI_SMOOTH;
    drawlist_in.draw_mode  &= ~DRAW_TRI_FLAT;
    drawlist_in.draw_mode  &= ~DRAW_TRI_POINTS;
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_mesh_points()
{
    drawlist_in.draw_mode  |=  DRAW_TRI_POINTS;
    drawlist_in.draw_mode  &= ~DRAW_TRI_FLAT;
    drawlist_in.draw_mode  &= ~DRAW_TRI_SMOOTH;
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_face_color()
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_face_quality()
{
    drawlist_out.draw_mode |=  DRAW_TRI_QUALITY;
    drawlist_out.draw_mode &= ~DRAW_TRI_FACECOLOR;
    drawlist_out.draw_mode &= ~DRAW_TRI_VERTCOLOR;
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_face_texture1D(const GLint texture)
{
    drawlist_out.draw_mode |=  DRAW_TRI_TEXTURE1D;
    drawlist_out.draw_mode &= ~DRAW_TRI_VERTCOLOR;
    drawlist_out.draw_mode &= ~DRAW_TRI_FACECOLOR;
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_face_wireframe(const bool b)
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_face_wireframe_color(const Color & c)
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_face_wireframe_width(const float width)
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_face_wireframe_transparency(const float alpha)
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_cell_color()
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_cell_quality()
{
    drawlist_in.draw_mode |=  DRAW_TRI_QUALITY;
    drawlist_in.draw_mode &= ~DRAW_TRI_FACECOLOR;
    drawlist_in.draw_mode &= ~DRAW_TRI_VERTCOLOR;
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_cell_texture1D(const GLint texture)
{
    drawlist_in.draw_mode |=  DRAW_TRI_TEXTURE1D;
    drawlist_in.draw_mode &= ~DRAW_TRI_VERTCOLOR;
    drawlist_in.draw_mode &= ~DRAW_TRI_FACECOLOR;
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_cell_wireframe(const bool b)
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_cell_wireframe_color(const Color & c)
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_cell_wireframe_width(const float width)
{
...
template<class M, class V, class E, class F, class C>
CINO_INLINE
void DrawableTet<M,V,E,F,C>::show_cell_wireframe_transparency(const float alpha)
{
    edge_set_alpha(alpha); // NOTE: this will change alpha for ANY adge (both interior and boundary)
}
