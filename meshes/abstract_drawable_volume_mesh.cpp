...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::init_drawable_stuff()
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::draw(const float) const
{
    render(drawlist_in );
    render(drawlist_out);
}
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::updateGL()
{
    updateGL_out();
    updateGL_in();
}
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::updateGL_out()
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::updateGL_in()
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::slice(const float thresh, // thresh on centroids or quality
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_mesh(const bool b)
{
    if (b)
    {
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_mesh_flat()
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_mesh_smooth()
{
    drawlist_in.draw_mode  |=  DRAW_TRI_SMOOTH;
    drawlist_in.draw_mode  &= ~DRAW_TRI_FLAT;
    drawlist_in.draw_mode  &= ~DRAW_TRI_POINTS;
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_mesh_points()
{
    drawlist_in.draw_mode  |=  DRAW_TRI_POINTS;
    drawlist_in.draw_mode  &= ~DRAW_TRI_FLAT;
    drawlist_in.draw_mode  &= ~DRAW_TRI_SMOOTH;
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_face_color()
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_face_quality()
{
    drawlist_out.draw_mode |=  DRAW_TRI_QUALITY;
    drawlist_out.draw_mode &= ~DRAW_TRI_FACECOLOR;
    drawlist_out.draw_mode &= ~DRAW_TRI_VERTCOLOR;
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_face_texture1D(const GLint texture)
{
    drawlist_out.draw_mode |=  DRAW_TRI_TEXTURE1D;
    drawlist_out.draw_mode &= ~DRAW_TRI_TEXTURE2D;
    drawlist_out.draw_mode &= ~DRAW_TRI_VERTCOLOR;
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_face_texture2D(const GLint texture, const double tex_unit_scalar)
{
    drawlist_out.draw_mode |=  DRAW_TRI_TEXTURE2D;
    drawlist_out.draw_mode &= ~DRAW_TRI_TEXTURE1D;
    drawlist_out.draw_mode &= ~DRAW_TRI_VERTCOLOR;
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_face_wireframe(const bool b)
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_face_wireframe_color(const Color & c)
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_face_wireframe_width(const float width)
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_face_wireframe_transparency(const float alpha)
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_cell_color()
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_cell_quality()
{
    drawlist_in.draw_mode |=  DRAW_TRI_QUALITY;
    drawlist_in.draw_mode &= ~DRAW_TRI_FACECOLOR;
    drawlist_in.draw_mode &= ~DRAW_TRI_VERTCOLOR;
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_cell_texture1D(const GLint texture)
{
    drawlist_in.draw_mode |=  DRAW_TRI_TEXTURE1D;
    drawlist_in.draw_mode &= ~DRAW_TRI_TEXTURE2D;
    drawlist_in.draw_mode &= ~DRAW_TRI_VERTCOLOR;
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_cell_texture2D(const GLint texture, const double tex_unit_scalar)
{
    drawlist_in.draw_mode |=  DRAW_TRI_TEXTURE2D;
    drawlist_in.draw_mode &= ~DRAW_TRI_TEXTURE1D;
    drawlist_in.draw_mode &= ~DRAW_TRI_VERTCOLOR;
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_cell_wireframe(const bool b)
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_cell_wireframe_color(const Color & c)
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_cell_wireframe_width(const float width)
{
...
template<class Mesh>
CINO_INLINE
void DrawableVolumeMesh<Mesh>::show_cell_wireframe_transparency(const float alpha)
{
    this->edge_set_alpha(alpha); // NOTE: this will change alpha for ANY adge (both interior and boundary)
    updateGL();
}
