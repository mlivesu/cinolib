...
using namespace std;
#define POLYGON_DIM 50
#define WIREFRAME_WIDTH 3
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
int main(int argc, char **argv)
{
    ...
    DrawablePolygonmesh<> sec(n_sided_polygon(sec_c, POLYGON_DIM, sec_r, Z));
    DrawablePolygonmesh<> mic(n_sided_polygon(mic_c, POLYGON_DIM, mic_r, Z));
    sec.show_mesh_points();
    mic.show_mesh_points();
    sec.show_wireframe(true);
    mic.show_wireframe(true);
    sec.show_wireframe_width(WIREFRAME_WIDTH);
    mic.show_wireframe_width(WIREFRAME_WIDTH);
    ...
    QSlider::connect(&slider, &QSlider::valueChanged, [&]()
    {
        ...
        polygon_maximum_inscribed_circle(m.vector_verts(), mic_c, mic_r);
        profiler.pop();
        sec.vector_verts() = n_sided_polygon(sec_c, POLYGON_DIM, sec_r, Z);
        mic.vector_verts() = n_sided_polygon(mic_c, POLYGON_DIM, mic_r, Z);
        sec.updateGL();
        mic.updateGL();

        cout << "kernel area: " << area << endl;
        cout << "radius of smallest enclosing circle: " << sec_r << endl;
        cout << "radius of maximum inscribed circle: " << mic_r << "\n" << endl;
